...
public class TC2 {
	...
	public Object[][] dp() {
		return new Object[][] { { "tholv1@fpt.edu.vn" }, { "nhatlh1@fpt.edu.vn" }, { "lanvtm1@fpt.edu.vn" },
				{ "hoant1@fpt.edu.vn" }, { "tienh1@fpt.edu.vn" } };
	}
	...
	public void beforeTest() {
		...
		driver.findElement(By.xpath("//input[@id='email_address']")).sendKeys("hieubqph13817@fpt.edu.vn");
