...
public class TC1 {
	...
	public void f() {
		...
		driver.findElement(By.xpath("//input[@id='email_address']")).sendKeys("hieubq123458@gmail.com");
		...
		// chèn email
		driver.findElement(By.xpath("//textarea[@id='email_address']")).sendKeys("abc@gmail.com");
	...
	public void p1() {
		...
		//Test case liên quan đến select
		// TV
		driver.findElement(By.xpath("//a[contains(text(),'TV')]")).click();
		
		//Dùng hàm select
		Select select = new Select(driver.findElement(
				By.xpath("//body/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/select[1]")));
		
		// Selected tại vị trí index
